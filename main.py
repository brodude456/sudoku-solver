...
while find_empty(board):
    emptyplaceslist.append(find_empty(board))
    board[find_empty(board)[0]][find_empty(board)[1]]=1
board=board_copy
...
def solve(bo):
    while True:
        ...
        if bruh==0:
            ...
            previus_not_filled_place=(emptyplaceslist[emptyplaceslist.index(pos)-1][0],emptyplaceslist[emptyplaceslist.index(pos)-1][1])

            dict[previus_not_filled_place].append(bo[emptyplaceslist[emptyplaceslist.index(pos)-1][0]][emptyplaceslist[emptyplaceslist.index(pos)-1][1]])
